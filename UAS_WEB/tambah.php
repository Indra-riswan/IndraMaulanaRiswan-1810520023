          ...
          <div class="card-body">
            ...
            <form style="padding: 30px;" action="" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nasi Goreng">
                </div>
                <div class="mb-3">
                <label for="harga" class="form-label">Harga Makanan</label>
                <input type="number" class="form-control" id="harga" name="harga" placeholder="15000">
                </div>
                <div class="mb-3">
                <label for="gambar" class="form-label">Inputkan Gambar</label>
